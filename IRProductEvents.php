...
{    
     ...
     */
    const PRODUCT_CREATE_COMPLETED = 'ir_product.admin.product.create.completed';
     ...
     * The event listener method receives a IR\Bundle\ProductBundle\Event\ProductEvent instance.
     */
    const PRODUCT_EDIT_COMPLETED = 'ir_product.admin.product.edit.completed';
     ...
     * The event listener method receives a IR\Bundle\ProductBundle\Event\ProductEvent instance.
     */
    const PRODUCT_DELETE_COMPLETED = 'ir_product.admin.product.delete.completed';  
    ...
    */
    const OPTION_CREATE_COMPLETED = 'ir_product.admin.option.create.completed';
     ...
     * The event listener method receives a IR\Bundle\ProductBundle\Event\OptionEvent instance.
     */
    const OPTION_EDIT_COMPLETED = 'ir_product.admin.option.edit.completed';
     ...
     * The event listener method receives a IR\Bundle\ProductBundle\Event\OptionEvent instance.
     */
    const OPTION_DELETE_COMPLETED = 'ir_product.admin.option.delete.completed';    
     ...
     */
    const VARIANT_CREATE_COMPLETED = 'ir_product.admin.variant.create.completed';
     ...
     * The event listener method receives a IR\Bundle\ProductBundle\Event\VariantEvent instance.
     */
    const VARIANT_EDIT_COMPLETED = 'ir_product.admin.variant.edit.completed';    
     ...
     * The event listener method receives a IR\Bundle\ProductBundle\Event\VariantEvent instance.
     */
    const VARIANT_DELETE_COMPLETED = 'ir_product.admin.variant.delete.completed';
}