                        ...
                        ->arrayNode('form')
                            ...
                            ->children()
                                ...
                                ->arrayNode('validation_groups')
                                    ...
                                    ->defaultValue(array('Product', 'Variant', 'Default'))
                                ->end()                  
                            ->end()
                        ->end()
                    ->end()
                        ...
                        ->arrayNode('form')
                            ...
                            ->children()
                                ->arrayNode('type')
                                    ->addDefaultsIfNotSet()
                                    ->children()
                                        ->scalarNode('variant')->defaultValue('ir_product_variant')->end()                
                                        ->scalarNode('master_variant')->defaultValue('ir_product_master_variant')->end()
                                    ->end()
                                ->end() 
                                ->arrayNode('name')
                                    ->addDefaultsIfNotSet()
                                    ->children()
                                        ->scalarNode('variant')->defaultValue('ir_product_variant_form')->end()                
                                        ->scalarNode('master_variant')->defaultValue('ir_product_master_variant_form')->end()
                                    ->end()
                                ->end() 
                                ->arrayNode('validation_groups')
                                    ->prototype('scalar')->end()
